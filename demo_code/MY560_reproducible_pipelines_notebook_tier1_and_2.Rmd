...
`git pull` (this pulls down the most recent version of the remote repo)
...
`git push` (this pushes your HEAD to the main remote repo, updating the remote repo with the changes you have made)
