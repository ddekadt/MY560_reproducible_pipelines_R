...
`git pull` (this pulls down the most recent version of the remote repo -- **ALWAYS** do this before you start changing things. **ALWAYS**)
...
`git push origin main` (this pushes your HEAD to the main remote repo, updating the remote repo with the changes you have made)
